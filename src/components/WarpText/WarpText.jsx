...
const buildTextCanvas = ({
  ...
  /*
   * Gunakan elemen tersembunyi
   * untuk mendapatkan ukuran font
   ...
   *
   * Sebelumnya 86%.
   * Sekarang 96% agar teks tidak
   * terlalu cepat mengecil.
   */
  ...
  /*
   * Jangan mengecilkan terlalu ekstrem.
   */
...
const syncUniforms = (
  ...
  uniforms.uWarpScale.value =
    props.warpScale;

  uniforms.uSpeed.value =
    props.speed;

  uniforms.uPointerInfluence.value =
    props.pointerInfluence;

  uniforms.uPointerStrength.value =
    props.pointerStrength;
...
const WarpText = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn(
        "WarpText: WebGL could not be initialized.",
        error
      );
